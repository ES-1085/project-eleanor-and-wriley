...
```{r echo = FALSE, main-four-species}
...
tower %>%
  ...
  geom_point(aes(x = year, y = median), color = "turquoise2") +
  geom_line(aes(x = year, y = median), color = "turquoise2")+ 
  geom_errorbar(aes(x = year, ymin = (median - se), ymax = (median + se)))
