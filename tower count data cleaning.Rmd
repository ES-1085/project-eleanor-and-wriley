...
splitcomments <- function(inputdataframe) {
  ...
  mutate(wisp = str_extract(other, "\\d*.WISP|d*wisp")) %>%  
  mutate(wisp = as.double(str_extract(wisp, "\\d*")))%>% 
    #LBBG
  mutate(lbbg = str_extract(other, "\\d*.LBBG|\\d*lbbg")) %>%  
...
```{r}
tower <- rbind(tower_2000_clean,tower_2001_clean,tower_2002_clean,tower_2003_clean,tower_2005_clean,tower_2006_clean,tower_2007_clean,tower_2008_clean,tower_2009_clean,tower_2010_clean,tower_2011_clean,tower_2012_clean,tower_2013_clean,tower_2014_clean,tower_2015_clean, tower_2016_clean,tower_2017_clean,tower_2018_clean,tower_2019_clean, tower_2020_clean, tower_2022_clean)
