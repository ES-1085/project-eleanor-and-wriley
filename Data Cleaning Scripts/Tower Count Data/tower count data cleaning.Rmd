...
##This function uses regex to extract numbers of birds from the "comment" column. There is one if/else pair for every species that should be extracted, and each species has a string of possible expressions used to refer to it. 
...
#This function selects the columns organized by the functions above, then pivots them to create a long dataframe where species is a single column. 
